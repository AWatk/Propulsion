  ...
  if (chartInstance->c3_is_active_c3_Rocket_SM_V2 == 0U) {
    ...
    switch (chartInstance->c3_is_c3_Rocket_SM_V2) {
     case c3_IN_GuideRail:
      ...
      c3_out = CV_EML_IF(3, 0, 0, (*c3_b_position)[1] >= 16.0);
      _SFD_SYMBOL_SCOPE_POP();
      if (c3_out) {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(14373041U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1245329061U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1377741734U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3890454143U);
}
...
mxArray *sf_c3_Rocket_SM_V2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dvnlsBsUM9KOazVQxS5Dz");
...
static void mdlSetWorkWidths_c3_Rocket_SM_V2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1812055612U));
  ssSetChecksum1(S,(3877486735U));
  ssSetChecksum2(S,(1278760189U));
  ssSetChecksum3(S,(2314448459U));
